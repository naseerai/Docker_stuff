# **Running a Webpage with Apache Server using Docker Compose**
...
Then a new file called **www** will be created Automatically

![alt text](<Screenshot (12).png>)


open the **www** file and create a **index.html** and paste your web page in the file
